        ...
        <CardContent className="space-y-4 pt-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Field
              name="vehicle_class"
              label="Class"
              defaultValue={vehicle?.vehicleClass ?? "Motor Car (LMV)"}
            />
            <Field
              name="emission"
              label="Emission norm"
              defaultValue={vehicle?.emission ?? "BS6"}
            />
            <div className="space-y-1">
              ...
              <select
                id="fuel"
                name="fuel"
                defaultValue={vehicle?.fuel ?? "PETROL"}
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="bg-background h-8 w-full rounded-lg border px-2 text-sm"
              >
                {["ACTIVE", "BLACKLISTED", "SCRAPPED"].map((s) => (
            ...
            <Field
              name="chassis_masked"
              label="Chassis (masked)"
              defaultValue={vehicle?.chassisMasked}
            />
            <Field
              name="engine_masked"
              label="Engine (masked)"
              defaultValue={vehicle?.engineMasked}
            />
          </div>
          ...
          <fieldset className="space-y-3 rounded-md border p-3">
            ...
            <Check
              name="hypo_active"
              label="Active loan on the RC"
              defaultChecked={vehicle?.hypothecation.active}
            />
            <Check
              name="hypo_form35_pending"
              label="Form 35 not yet filed"
              defaultChecked={vehicle?.hypothecation.form35Pending}
            />
            <div className="grid gap-3 sm:grid-cols-2">
              <Field
                name="hypo_financier"
                label="Financier"
                defaultValue={vehicle?.hypothecation.financier}
              />
              <Field
                name="hypo_since"
                label="Since"
                type="date"
                defaultValue={vehicle?.hypothecation.since}
              />
            </div>
          </fieldset>
          ...
          <fieldset className="grid gap-3 rounded-md border p-3 sm:grid-cols-2">
            ...
            <Field
              ...
              type="date"
              defaultValue={vehicle?.insurance.validTill}
            />
            <Field
              name="puc_till"
              label="PUC valid till"
              type="date"
              defaultValue={vehicle?.puc.validTill}
            />
            <Field
              name="tax_till"
              label="Road tax till"
              type="date"
              defaultValue={vehicle?.tax.paidTill}
            />
            <Field
              name="fitness_till"
              label="Fitness till (commercial)"
              type="date"
              defaultValue={vehicle?.fitness?.validTill}
            />
          </fieldset>
          ...
          <fieldset className="space-y-3 rounded-md border p-3">
            ...
            <Check
              name="accident_flag"
              label="Accident on record"
              defaultChecked={vehicle?.accident.flag}
            />
            <Field
              name="accident_note"
              label="Accident note"
              defaultValue={vehicle?.accident.note}
            />
            <div className="grid gap-3 sm:grid-cols-2">
              <Field
                name="fair_price_min"
                label="Fair price min (₹)"
                type="number"
                defaultValue={vehicle?.fairPrice.min}
              />
              <Field
                name="fair_price_max"
                label="Fair price max (₹)"
                type="number"
                defaultValue={vehicle?.fairPrice.max}
              />
            </div>
          </fieldset>
