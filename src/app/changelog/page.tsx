      ...
      >
        <div className="space-y-6">
          {CHANGELOG.map((release) => (
            <Card key={release.version} className="bg-card/80 backdrop-blur-md">
              <CardHeader>
          ...
          <Card className="bg-card/80 backdrop-blur-md">
            <CardHeader>
              ...
              <CardDescription>
                Scoped to Gujarat, because that is the state the research walked. Each one runs end
                to end on synthetic data under{" "}
            ...
            <CardContent>
              <ul className="text-muted-foreground list-disc space-y-1 pl-5 text-sm">
                ...
                <li>
                  Fancy-number auctions you can browse before logging in (40 Gujarat RTO codes)
                </li>
