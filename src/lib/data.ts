...
export const FLEET: Vehicle[] = [
  {
    ...
    status: "ACTIVE",
    owners: [
      { serial: 1, name: "Rajesh Patel", maskedName: "RA****H P***L", from: "2021-03-15", to: "2023-08-02" },
      { serial: 2, name: "Amit Shah", maskedName: "AM** S**H", from: "2023-08-02" },
    ],
    hypothecation: { active: true, financier: "HDFC Bank Ltd", since: "2023-08-02", form35Pending: true },
    insurance: { insurer: "ICICI Lombard", validTill: "2027-02-11" },
    puc: { validTill: "2026-11-20" },
    tax: { paidTill: "2036-03-14" },
    challans: [
      { id: "CH-88121", date: "2025-12-04", offense: "Over-speeding (MV Act 183)", amount: 1500, status: "PAID" },
      { id: "CH-91245", date: "2026-05-18", offense: "No parking zone", amount: 500, status: "PENDING" },
    ],
    accident: { flag: false },
  ...
  },
  {
    ...
    status: "ACTIVE",
    owners: [
      { serial: 1, name: "Suresh Mehta", maskedName: "SU****H M***A", from: "2019-01-22", to: "2021-05-30" },
      { serial: 2, name: "Kiran Joshi", maskedName: "KI**N J***I", from: "2021-05-30", to: "2024-02-14" },
    ...
    challans: [
      { id: "CH-45332", date: "2024-11-02", offense: "Signal jump (MV Act 184)", amount: 5000, status: "PENDING" },
      { id: "CH-45890", date: "2025-01-15", offense: "Driving without seatbelt", amount: 1000, status: "PENDING" },
      { id: "CH-51002", date: "2025-09-21", offense: "Over-speeding (MV Act 183)", amount: 2000, status: "PENDING" },
    ],
    accident: { flag: true, note: "Major damage claim recorded (insurer, 2023). Structural repair indicated." },
  ...
  },
  {
    ...
    challans: [{ id: "CH-99011", date: "2025-06-19", offense: "Vehicle reported in theft case", amount: 0, status: "DISPUTED" }],
    accident: { flag: false },
  ...
  },
  {
    ...
    status: "ACTIVE",
    owners: [
      { serial: 1, name: "Naman Doshi", maskedName: "NA*** D***I", from: "2017-04-18" },
    ],
    hypothecation: { active: false },
    insurance: { insurer: "United India", validTill: "2026-04-02" },
    puc: { validTill: "2026-06-15" },
    tax: { paidTill: "2032-04-17" },
    challans: [{ id: "CH-77120", date: "2026-07-01", offense: "Expired PUC (MV Act 190(2))", amount: 1000, status: "PENDING" }],
    accident: { flag: false },
  ...
  },
  {
    ...
    status: "ACTIVE",
    owners: [{ serial: 1, name: "Bharat Transport Co", maskedName: "BH***T T******T CO", from: "2021-11-25" }],
    hypothecation: { active: true, financier: "Cholamandalam Finance", since: "2021-11-25", form35Pending: false },
    ...
    challans: [{ id: "CH-33451", date: "2026-02-11", offense: "Overloading (MV Act 194)", amount: 20000, status: "PAID" }],
    accident: { flag: false },
  ...
  },
  {
    ...
    status: "SCRAPPED",
    owners: [{ serial: 1, name: "Hasmukh Trivedi", maskedName: "HA****H T*****I", from: "2008-08-30", to: "2025-12-01" }],
    hypothecation: { active: false },
