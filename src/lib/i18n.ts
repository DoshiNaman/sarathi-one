...
const dict = {
  ...
  disclaimerLink: { en: "What's real", hi: "क्या असली है" },
  ...
  navCheck: { en: "Check", hi: "जांचें" },
  navGarage: { en: "Garage", hi: "गैराज" },
  navStatus: { en: "Status", hi: "स्थिति" },
  navHow: { en: "How it works", hi: "कैसे काम करता है" },
